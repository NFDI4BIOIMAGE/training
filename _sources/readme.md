...
1. [Melanoma Histopathology Dataset with Tissue and Nuclei Annotations](https://zenodo.org/records/15050523) by "Schuiveling, Mark" (172 downloads), licensed [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/)

2. [I3D:bio's OMERO training material: Re-usable, adjustable, multi-purpose slides for local user training](https://zenodo.org/records/8323588) by "Schmidt, Christian and Bortolomeazzi, Michele and Boissonnet, Tom and Fortmann-Grote, Carsten and Dohle, Julia and Zentis, Peter and Kandpal, Niraj and Kunis, Susanne and Zobel, Thomas and Weidtkamp-Peters, Stefanie and Ferrando-May, Elisa" (137 downloads), licensed [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/)

3. [FAQ Künstliche Intelligenz und gute wissenschaftliche Praxis](https://zenodo.org/records/14045172) by "Frisch, Katrin" (136 downloads), licensed [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/)
